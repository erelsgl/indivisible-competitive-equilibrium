...
prefs_of_Alice = preferences.goods_to_chores(items, quintuplets + quartets + ["vwx","vwy","vwz","vw","xyz"] + triplets_except_vwx_vwy_vwz_xyz + pairs_except_vw + singletons + [""])
prefs_of_Bob   = preferences.goods_to_chores(items, quintuplets + quartets + triplets_except_xyz + ["vx","vy","vz","wx","wy","wz","xyz","vw","w","v","xy","xz","yz","x","y","z"] + [""])
# print(prefs_of_Alice)
# print(prefs_of_Bob)
budgets = [-10,-12]
...
# print(alternative_prefs_of_Bob)
