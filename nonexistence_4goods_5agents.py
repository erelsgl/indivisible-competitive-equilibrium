...
prefs_of_Others  = quartets + triplets + pairs + singletons
preferences = [prefs_of_Alice, prefs_of_Bob, prefs_of_Carl, prefs_of_Others, prefs_of_Others]
budgets = [16, 11, 9, 6, 5]
...
ce.display(ce.find_equilibrium(items, preferences, alternative_budgets))
